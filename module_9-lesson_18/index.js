 ...
 * -catch
 * -finally
 * -chaining (return promise)
 * -fetch
 * -unhandledrejection
 * -Promise static methods(6)
 *    all
 *    allSattled
 *    race
 *    any
...
const promiseOrders = new Promise((resolve, reject) => {
  setTimeout(() => {
    reject({status: 404, message: "api not found"})
    // resolve([])
  }, 1000)
}); 

// Promise.all([promiseUsers, promiseOrders]).then(result => {
//   console.log(result)
// })
// .catch(err => {
//   console.error(err)
...
// Promise.allSettled([promiseUsers, promiseOrders])
// .then(result => {
//   console.log(result)
// })
// .catch(err => {
...
// Promise.race([promiseUsers, promiseOrders])
// .then(result => {
//   console.log(result)
// })
// .catch(err => {
...
// Promise.any([promiseUsers, promiseOrders])
// .then(result => {
//   console.log(result)
// })
// .catch(err => {
...
//   parsed.then(userList => {
//     console.table(userList)
//     userList.forEach(elem => {
//       ulRef.insertAdjacentHTML('beforeEnd', `<li>${elem.login} ${elem.id}</li>`)
//     })
//   })
// })
// .catch( err => {
...
//   reject('I am unhendled rejection from Promise, Catch me if you can!')
// })
...
// .finally(() => console.info('I am invoking all time!'))
...
// } else {
//   console.log('ELSE statement false')
// }
